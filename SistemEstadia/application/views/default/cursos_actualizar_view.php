...
<html>
    ...
    <tr>
        <td width="230">Material del Curso </td>
        <td width="329" valign='middle' align='left' style=''><input type="text" name="material" value="<?php echo $row->material; ?>"/></td>
    </tr>
    <tr>
        <td width="230">Examen del Curso </td>
        <td width="329" valign='middle' align='left' style=''><input type="text" name="examen" value="<?php echo $row->examen; ?>"/></td>
    </tr>
    <tr>
        <td width="230">Clasificación </td>
        <td width="329" valign='middle' align='left' style=''><select name="clasificacion" for="clasificacion">
    ...
    <tr>
        <td width="230">Observación</td>
        <td width="329" valign='middle' align='left' style=''><input style="width: 400px;" type="text" name="observacion" value="<?php echo $row->observacion; ?>" /></td>
    </tr>
    <tr>
        <td width="230">Fecha de creación</td>
        <td width="329" valign='middle' align='left' style=''><input type="date" name="fecha" value="<?php echo $row->fecha; ?>"/></td>
    </tr>
    <tr>
